...
def getEmbd(id_list):
    entity2id = {}
    id2entity = {}
    with open("/data/fracture/KG/drkg/embed/entities.tsv", newline='', encoding='utf-8') as csvfile:
    ...
    entity_emb = np.load('/data/fracture/KG/drkg/embed/DRKG_TransE_l2_entity.npy')
    dataset_id = {}
